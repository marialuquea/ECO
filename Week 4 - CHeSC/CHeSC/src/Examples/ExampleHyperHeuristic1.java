...
public class ExampleHyperHeuristic1 extends HyperHeuristic {
	...
	public void solve(ProblemDomain problem) {
	    ...
	    //System.out.println("initial fitness is " + problem.getBestSolutionValue());
		...
		while (!hasTimeExpired()) {
			...
			System.out.print(problem.getFunctionValue(0)+ " " + problem.getFunctionValue(1)+ " ");
			
			System.out.println(problem.compareSolutions(0,1));
			...
			//System.out.println("obj is " + current_obj_function_value);
			//System.out.println("best fitness is " + problem.getBestSolutionValue() + " at iter " + iterations);
			iterations++;
		}
	}
